...
<section style="height: 100%; width: 100%; box-sizing: border-box; background-color: #f0f0f0">
    ...
    <div class="mx-auto text-center justify-content-center pb-5 pt-3">
        <h1 class="title-text-big-header-4-3">Our Team</h1>
        <h3><span class="badge bg-light text-primary">4 Member</span></h3>
    </div>
